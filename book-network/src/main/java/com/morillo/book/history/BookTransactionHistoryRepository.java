package com.morillo.book.history;
...
public interface BookTransactionHistoryRepository extends JpaRepository<BookTransactionHistory, Integer> {
                        // (COUNT (*) > 0) AS isBorrowed        SELECCIONA TODOS AQUELLOS QUE COINCIDAN CON LA CONSULTA
                        // returnApproved                       SIGNIFICA QUE AUN EL LIBRO NO HA SIDO DEVUELTO.
    @Query("""
            SELECT
